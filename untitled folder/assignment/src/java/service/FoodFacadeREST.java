...
public class FoodFacadeREST extends AbstractFacade<Food> {
    ...
    @Produces({"application/json"})
     public List<Food> findByFoodName(@PathParam("foodName") String
    foodName) {
    ...
    @Produces({"application/json"})
     public List<Food> findByFoodId(@PathParam("foodId") Integer
    foodId) {
    ...
    @Produces({"application/json"})
     public List<Food> findByCategory(@PathParam("category") String
    category) {
    ...
    @Produces({"application/json"})
     public List<Food> findByServingUnit(@PathParam("servingUnit") String
    servingUnit) {
    ...
    @Produces({"application/json"})
     public List<Food> findByServingAmount(@PathParam("servingAmount") Integer
    servingAmount) {
    ...
    @Path("findByFat/{fat}")
    @Produces({"application/json"})
     public List<Food> findByFat(@PathParam("fat") Integer
    fat) {
